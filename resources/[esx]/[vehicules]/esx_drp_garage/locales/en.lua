Locales['en'] = {
    ...
    ['spawn'] = 'Appuyer sur ~INPUT_PICKUP~ pour sortir un véhicule',
    ['delete'] = 'Appuyer sur  ~INPUT_PICKUP~ pour ranger un véhicule',
    ['pound_action_menu'] = 'Appuyer sur ~INPUT_PICKUP~ pour entrer dans la cour de la fourrière',
