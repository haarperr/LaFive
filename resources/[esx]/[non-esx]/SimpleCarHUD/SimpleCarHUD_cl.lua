...
local fuelColorUnder = {255, 176, 96}       -- Color used to display fuel warning
    ...
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
				...
				-- local fuelColor = (currentFuel >= fuelEmptyLimit) and fuelColor or fuelColorEmpty
                ...
                drawTxt("LIMITEUR", 2, cruiseColor, 0.4, screenPosX + 0.040, screenPosY + 0.048)
