Citizen.Trace('\n')
Citizen.Trace('PERSONAL MENU v1.1 by Larko\n')
Citizen.Trace('Created for LaFive\n')
Citizen.Trace('LRK MENU LF\n')
Citizen.Trace('\n')
...
-- Weapon Menu --
RegisterNetEvent('KorioZ-PersonalMenu:Weapon_AmmoToPedC')
AddEventHandler('KorioZ-PersonalMenu:Weapon_AmmoToPedC', function(value, quantity)
...
-- Admin Menu --
RegisterNetEvent('KorioZ-PersonalMenu:Admin_teleC')
AddEventHandler('KorioZ-PersonalMenu:Admin_teleC', function(plyPedCoords)
...
function admin_tp_playertome()
	...
	if plyId ~= nil then
		...
		if type(plyId) == 'number' then
			...
			TriggerServerEvent('KorioZ-PersonalMenu:Admin_teleS', plyId, plyPedCoords)
		end
	end
end
...
function admin_give_money()
	...
	if amount ~= nil then
		...
		if type(amount) == 'number' then
			TriggerServerEvent('KorioZ-PersonalMenu:Admin_Cash', amount)
		end
	end
end
...
function admin_give_bank()
	...
	if amount ~= nil then
		...
		if type(amount) == 'number' then
			TriggerServerEvent('KorioZ-PersonalMenu:Admin_Bank', amount)
		end
	end
end
...
function admin_give_dirty()
	...
	if amount ~= nil then
		...
		if type(amount) == 'number' then
			TriggerServerEvent('KorioZ-PersonalMenu:Admin_DirtyMoney', amount)
		end
	end
end
...
function AddMenuInventoryMenu(menu)
	...
	local simItem = NativeUI.CreateItem(('Mes carte(s) SIM'), "")
	simItem:RightLabel("→") 
	inventorymenu.SubMenu:AddItem(simItem)

	local blankItem = NativeUI.CreateItem((''), "")
	blankItem:SetRightBadge(21)
	inventorymenu.SubMenu:AddItem(blankItem)
										...
										if ammo > 0 then
											if post == true then
												if quantity <= ammo and quantity >= 0 then
													...
													TriggerServerEvent('KorioZ-PersonalMenu:Weapon_AmmoToPedS', GetPlayerServerId(personalmenu.closestPlayer), value, quantity)
		...
		if item == recruterItem then
			if ESX.PlayerData.job.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('KorioZ-PersonalMenu:Patron_recruterplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name, 0)
				end
			else
		...
		elseif item == virerItem then
			if ESX.PlayerData.job.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('KorioZ-PersonalMenu:Patron_virerplayer', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		elseif item == promouvoirItem then
			if ESX.PlayerData.job.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('KorioZ-PersonalMenu:Patron_promouvoirplayer', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		...
		if item == recruter2Item then
			if ESX.PlayerData.job2.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('KorioZ-PersonalMenu:Patron_recruterplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name, 0)
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		elseif item == virer2Item then
			if ESX.PlayerData.job2.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('KorioZ-PersonalMenu:Patron_virerplayer2', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
		elseif item == promouvoir2Item then
			if ESX.PlayerData.job2.grade_name == 'boss' then
				...
				if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
					...
					TriggerServerEvent('KorioZ-PersonalMenu:Patron_promouvoirplayer2', GetPlayerServerId(personalmenu.closestPlayer))
				end
			else
				ESX.ShowNotification(_U('missing_rights'))
			end
