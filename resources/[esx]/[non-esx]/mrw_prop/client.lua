		    ...
		    elseif WarMenu.ComboBox('Interieur', items, currentItemIndex, selectedItemIndex, function(currentIndex, selectedIndex)
		        ...
		        elseif selectedItemIndex == 7 then 
		    	    ...
		    	    if checkbox == false then 
						...
						inside = '{"x":1026.5056,"y":-3099.8320,"z":-39.9998}'
						exit   = '{"x":998.1795"y":-3091.9169,"z":-39.9999}'
						isSingle = 1
					    isRoom = 1
					    isGateway = 0
						SetEntityCoords(GetPlayerPed(-1), 1026.8707, -3099.8710, -39.9998)		
					end	
		        ...
		        elseif selectedItemIndex == 8 then 
		    	    ...
		    	    if checkbox == false then 
                       Cam('Entrepot2')
						...
						inside = '{"x":1048.5067,"y":-3097.0817,"z":-39.9999}'
						exit   = '{"x":1072.5505,"y":-3102.5522,"z":-39.9999}'
						isSingle = 1
					    isRoom = 1
					    isGateway = 0
						SetEntityCoords(GetPlayerPed(-1), 1072.8447, -3100.0390, -39.9999)		
					end	
		        ...
		        elseif selectedItemIndex == 9 then 
		    	    ...
		    	    if checkbox == false then 
                      Cam('Entrepot3')
						...
						inside = '{"x":1088.1834,"y":-3099.3547,"z":-39.9999}'
						exit   = '{"x":1104.6102,"y":-3099.4333,"z":-39.9999}'
						isSingle = 1
					    isRoom = 1
					    isGateway = 0
						SetEntityCoords(GetPlayerPed(-1), 1104.7231, -3100.0690, -39.9999)		
					end		
