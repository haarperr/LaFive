...
function AddEmoteMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['emotes'], "", "")
    local dancemenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['danceemotes'], "", "")
    local propmenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['propemotes'], "", "")
...
function AddCancelEmote(menu)
    ...
    newitem:SetRightBadge(BadgeStyle.Alert)
...
RegisterNetEvent('NB:emote')
AddEventHandler('NB:emote', function()
	OpenEmoteMenu()
end)