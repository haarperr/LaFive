...
AddEventHandler("Fax:ServerPassword:ShowPasswordPrompt", function()
    local password = KeyboardInput("discord.lafiverp.fr #mot-de-passe (" .. attempts .. " tentative" .. (attempts == 1 and "" or "s") .. " restantes)", "", 30)
    attempts = attempts - 1
...
AddEventHandler('Fax:ServerPassword:PassedPassword', function()
    ...
    TriggerEvent("esx:showAdvancedStreamedNotification", 'LaFive', 'Information ⚠️', 'Mot de passe ~y~validé', 'CHAR_FLOYD', 'lafive', 2)
end)
