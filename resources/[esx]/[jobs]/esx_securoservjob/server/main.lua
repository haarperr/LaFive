...
AddEventHandler('esx_securoservjob:getStockItem1', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_securoserv1', function(inventory)
...
RegisterServerEvent('esx_securoservjob:putStockItems1')
AddEventHandler('esx_securoservjob:putStockItems1', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
	local sourceItem = xPlayer.getInventoryItem(itemName)
...
ESX.RegisterServerCallback('esx_securoservjob:getStockItems1', function(source, cb)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_securoserv1', function(inventory)
		cb(inventory.items)
	end)
end)
