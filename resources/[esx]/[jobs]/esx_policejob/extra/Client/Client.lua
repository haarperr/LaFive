...
local MainMenu = UIMenu.New('Véhicule Extra', '~b~Activer/~r~Désactiver ~w~les extra de véhicules')
...
function VEM.DeleteMenu()
	...
	MainMenu = UIMenu.New('Véhicule Extra', '~b~Activer/~r~Désactiver ~w~les extra de véhicules')
	Menupool:Add(MainMenu)
	MenuExists = false
	DeletingMenu = false
end
