...
AddEventHandler('esx_policejob:handcuff', function(target)
	...
	bandata = {}
	bandata.reason = 'ORIGINAL ANTI-CHEAT | INJECTOR - esx_policejob'
...
ESX.RegisterServerCallback('esx_policejob:removeArmoryWeapon', function(source, cb, weaponName, WeaponLabel)
