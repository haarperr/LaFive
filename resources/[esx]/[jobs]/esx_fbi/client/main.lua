        ...
        {label = _U('revive player'),       value = 'revive'}
          ...
          function(data2, menu2)
            ...
            if data2.current.value == 'revive' then 
              ...
              elseif data2.current.value == 'identity_card' then
              ...
              elseif data2.current.value == 'fine' then
                  OpenFineMenu(player)
              end
          ...
          function(data, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(closestPlayer), 'society_fib', 'Fib', amount)
              end
            end
          end,
        function(data, menu)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(player), 'society_fib', _U('fine_total', label), amount)
        else
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            if
              ...
              GetEntityModel(vehicle) == GetHashKey('FBI')        
            then
