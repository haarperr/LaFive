...
Locales['fr'] = {
	...
	['fueler_client'] = 'Client Imprimerie',
	['transforming_in_progress'] = 'Transformation du Papier en cours...',
	['petrol_taken'] = 'Vous êtes en train de ramasser du papier',
	['press_traitement'] = 'Appuyez sur ~INPUT_CONTEXT~ pour transformer le papier',
	['press_traitement_raffine'] = 'Appuyez sur ~INPUT_CONTEXT~ pour transformer le papier',
	['press_collect'] = 'Appuyez sur ~INPUT_CONTEXT~ pour récolter du papier',
	['press_sell'] = 'Appuyez sur ~INPUT_CONTEXT~ pour vendre vos produits',
	['no_petrole_sale'] = 'Vous n\'avez plus ou pas assez de papier',
	['no_fuel_sale'] = 'Vous n\'avez plus ou pas assez de papier',
	['not_enough_petrol'] = 'Vous n\'avez plus de billet',
	['not_enough_raffine'] = 'Vous n\'avez plus de billet',
	['no_jus_sale_essence'] = 'Vous n\'avez plus de billet',
