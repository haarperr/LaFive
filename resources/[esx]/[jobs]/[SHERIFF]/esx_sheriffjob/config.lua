...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Vehicles = {
			{
				Spawner = vector3(-434.95, 6030.77, 31.34),
...

			{
				...
				InsideShop = vector3(-33363.0073, 6072.501, 30.4982),
				SpawnPoints = {
		...
		Helicopters = {
			{
				Spawner = vector3(-47330.546, 6005.318, 31.30),
				InsideShop = vector3(-33363.0073, 6072.501, 30.4982),
				SpawnPoints = {
...
Config.AuthorizedWeapons = {
	...
	sergeant_chief = {
		{ weapon = 'WEAPON_REVOLVER', components = { 0, 0, 1000, 4000, nil }, price = 10000 },
		--{ weapon = 'WEAPON_ADVANCEDRIFLE', components = { 0, 6000, 1000, 4000, 8000, nil }, price = 0 },
		--{ weapon = 'WEAPON_PUMPSHOTGUN', components = { 2000, 6000, nil }, price = 70000 },
		{ weapon = 'WEAPON_NIGHTSTICK', price = 1000 },
		{ weapon = 'WEAPON_STUNGUN', price = 5000 },
	...
	lieutenant = {
		{ weapon = 'WEAPON_REVOLVER', components = { 0, 0, 1000, 4000, nil }, price = 1500 },
		--{ weapon = 'WEAPON_APPISTOL', components = { 0, 0, 1000, 4000, nil }, price = 10000 },
		--{ weapon = 'WEAPON_ADVANCEDRIFLE', components = { 0, 6000, 1000, 4000, 8000, nil }, price = 0 },
		--{ weapon = 'WEAPON_PUMPSHOTGUN', components = { 2000, 6000, nil }, price = 70000 },
		{ weapon = 'WEAPON_NIGHTSTICK', price = 1000 },
	...
	boss = {
		--{ weapon = 'WEAPON_APPISTOL', components = { 0, 0, 1000, 4000, nil }, price = 10000 },
		--{ weapon = 'WEAPON_ADVANCEDRIFLE', components = { 0, 6000, 1000, 4000, 8000, nil }, price = 0 },
		--{ weapon = 'WEAPON_MUSKET', components = { 2000, 6000, nil }, price = 3000 },
		{ weapon = 'WEAPON_REVOLVER', price = 1000 },
		{ weapon = 'WEAPON_NIGHTSTICK', price = 400 },
		{ weapon = 'WEAPON_STUNGUN', price = 750 },
...
Config.AuthorizedHelicopters = {
	...
	lieutenant = {
		{ model = 'sheriffmav', label = 'Sheriff Maverick', price = 0 },
	},
...
Config.AuthorizedVehicles = {
	...
	officer = {
		{ model = 'bcso1', label = 'Sheriff Cruiser 2', price = 0 },
		--{ model = 'sheriffvan', label = 'Sheriff Van', price = 0 },
		{ model = 'police4', label = 'Sheriff Banalisée', price = 0 }
	},

	sergeant = {
		{ model = 'bcso1', label = 'Sheriff Cruiser 2', price = 0 },
		--{ model = 'sheriffvan', label = 'Sheriff Van', price = 0 },
		{ model = 'bcso3', label = 'Sheriff Dodge', price = 0 },
		{ model = 'police4', label = 'Sheriff Banalisée', price = 0 },
		{ model = 'pranger', label = 'Sheriff SUV', price = 0 },
		{ model = 'policeb', label = 'Sheriff Moto', price = 0 },
		{ model = 'riot', label = 'Sheriff RIOT', price = 0 },
		{ model = 'pbus', label = 'Bus Pénitenciaire', price = 0 }
	},
	...
	lieutenant = {
		{ model = 'bcso1', label = 'Sheriff Cruiser 2', price = 0 },
		--{ model = 'sheriffvan', label = 'Sheriff Van', price = 0 },
		{ model = 'bcso6', label = 'Sheriff Dodge', price = 0 },
		{ model = 'police4', label = 'Sheriff Banalisée', price = 0 },
		{ model = 'pranger', label = 'Sheriff SUV', price = 0 },
		{ model = 'policeb', label = 'Sheriff Moto', price = 0 },
		{ model = 'riot', label = 'Sheriff RIOT', price = 0 },
		{ model = 'bcso4', label = 'Sheriff Moto', price = 0 },
		{ model = 'pbus', label = 'Bus Pénitenciaire', price = 0 }
	},
	...
	boss = {
		...
		{ model = 'policeb', label = 'Sheriff Moto', price = 0 },
		{ model = 'riot', label = 'Sheriff RIOT', price = 0 },
		{ model = 'bcso4', label = 'Sheriff SUV 2', price = 0 },
		{ model = 'bcso5', label = 'Sheriff SUV de Sheriff', price = 0 },
		{ model = 'bcso3', label = 'Sheriff Dodge de Sheriff', price = 0 },
		{ model = 'pbus', label = 'Bus Pénitenciaire', price = 0 }
