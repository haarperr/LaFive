...
function OpenVehicleSpawnerMenu()
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		local elements = {
			{label = '4X4',  value = 'sandking2'},
			{label = 'Van',  value = 'speedo'},
		}
						...
						if amount == nil or amount <= 0 then
							...
							if closestPlayer == -1 or closestDistance > 3.0 then
								...
								Citizen.CreateThread(function()
									...
									TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(closestPlayer), 'society_fueler', 'Raffinerie', amount)
								end)
							end
						end
					end,
...
function blips()
	if publicBlip == false then
		...
		AddTextComponentString("~o~Entreprise de Whiskey")
