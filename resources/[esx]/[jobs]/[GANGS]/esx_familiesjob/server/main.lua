...
TriggerEvent('esx_organisation:registerSociety', 'families', 'families', 'organisation_families', 'organisation_families', 'organisation_families', {type = 'public'})
...
ESX.RegisterServerCallback('esx_familiesjob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'organisation_families', function(account)
