          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_faction2:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_faction2:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_faction2:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_faction2:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_faction2:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_faction2:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_faction2:getVehicleInfos', function(infos)
...
RegisterNetEvent('esx_faction2:handcuff')
AddEventHandler('esx_faction2:handcuff', function()
...
RegisterNetEvent('esx_faction2:drag')
AddEventHandler('esx_faction2:drag', function(cop)
...
RegisterNetEvent('esx_faction2:putInVehicle')
AddEventHandler('esx_faction2:putInVehicle', function()
...
RegisterNetEvent('esx_faction2:OutVehicle')
AddEventHandler('esx_faction2:OutVehicle', function(t)
...
Citizen.CreateThread(function()
    ...
    -- if IsControlJustReleased(0, Keys['F9']) and Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.grade_name ~= 'recrue' then
		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'bratva' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
		OpenBanditsMenu()
        end 
    end
end)
