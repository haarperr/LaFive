...
function SetVehicleMaxMods(vehicle)
  ...
  local props = {
    ...
    modSuspension   = 3,
    modTurbo        = true,
    SetVehicleCustomPrimaryColour(vehicle, 235, 232, 54),
    SetVehicleCustomSecondaryColour(vehicle, 235, 232, 54),
  }
...
local blips = {
  ...
  {title="~y~Vagos", colour=5, id=84, x = 326.88, y = -2033.65, z = 20.65}
  }
  Citizen.CreateThread(function()
