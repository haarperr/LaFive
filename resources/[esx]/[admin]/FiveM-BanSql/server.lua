				...
				'DELETE FROM banlist WHERE targetplayername = @name',
				{
				  ['@name']  = data[1].targetplayername
					...
					if Config.EnableDiscordLink then
						...
						sendToDiscord("https://discordapp.com/api/webhooks/654080739956228107/y9N7lt2REFwEtIH8QDutUfW-dLZOztln5BLbx-273yYxFW-qumYHpb37PLxbG9LM-KR2", message)
					end
...
--calcul total expiration (en secondes)
	...
	if expiration < os.time() then
		...
		if Config.EnableDiscordLink then
			...
			sendToDiscord("https://discordapp.com/api/webhooks/654076613805473822/RsNpfMectjn9-D5tMASN1YO3qLW_8MFBx5Yt0mW5SdqWqo7ZcEZj8HgJep0yCj7BMxpt", message)
		end
