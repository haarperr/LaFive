...
Citizen.CreateThread(function()
	...
	while true do
		...
		for k, v in ipairs(Config.Shops) do
			...
			if GetDistanceBetweenCoords(coords, v, true) < Config.DrawDistance then

				DrawMarker(29, v, vector3(0.0, 0.0, 0.0), vector3(0.0, 180.0, 0.0), vector3(0.5, 0.5, 0.5), 0, 255, 0, 100, true, false, 2, false)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		for k, v in pairs(Config.Shops) do
			...
			if GetDistanceBetweenCoords(coords, v, true) < Config.MarkerSize.x then
