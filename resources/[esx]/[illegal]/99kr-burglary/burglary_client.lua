...
local text = "~g~[E]~w~ pour Lockpick" -- lockpick the door
local textUnlock = "~g~[E]~w~ Entrer" -- enter the house
local insideText = "~g~[E]~w~ Sortir" -- exit the door
local searchText = "~g~[E]~w~ Fouiller" -- search the spot
local emptyMessage = "Y a rien ici!" -- if you press E where it is empty
local emptyMessage3D = "~r~Vide" -- if the spot is empty
local closetText = "~g~[E]~w~ Jeter un coup d'oeil dans le placard" -- text at closet

local lockpickQuestionText = "Voulez-vous lockpick?" -- confirmation menu title
local noLockpickText = "Vous n'avez pas de lockpick" -- if you don't have a lockpick and you try to do the burglary
local yesText = "Oui" -- in confirmation menu
local noText = "Non" -- -- in confirmation menu

local shirt = "Tshirt" -- in menu and notification
local pants = "Pantalons" -- -- in menu and notification
local hat = "Chapeaux" -- -- in menu and notification
local shoes = "Souliers" -- -- in menu and notification

local youFound = "Vous avez trouvé " -- when you steal something
local burglaryDetected = "Un cambriolage a été detecté a" -- text 1 cops gets sent
local sentPhoto = "Nous vous avons envoyé une photo du cambrioleur." -- if you use qalle's camerasystem this will be in the message too
            ...
            if useQalleCameraSystem == true then
              if random <= chancePoliceNoti then                           -- chance police get notified and they get a photo of you
                TriggerEvent('skinchanger:getSkin', function(skin)
                  ...
                  TriggerServerEvent('esx_addons_gcphone:startCall', 'police', burglaryDetected .. ' ' .. house, PlayerCoords, {
