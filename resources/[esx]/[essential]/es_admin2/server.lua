...
TriggerEvent('es:addCommand', 'report', function(source, args, user)
	 TriggerClientEvent('chatMessage', source, "REPORT", {255, 0, 0}, " | ^2[" ..source.."] | ^6".. GetPlayerName(source) .."^0 : " .. table.concat(args, " "))

	TriggerEvent("es:getPlayers", function(pl)
		for k,v in pairs(pl) do
			TriggerEvent("es:getPlayerFromId", k, function(user)
				if(user.getPermissions() > 0 and k ~= source)then
					 TriggerClientEvent('chatMessage', k, "REPORT", {255, 0, 0}, " | ^2[" ..source.."] | ^6".. GetPlayerName(source) .."^0 : " .. table.concat(args, " "))
				end
			end)
		end
	end)
end, {help = "Signaler un joueur ou un problème", params = {{name = "report", help = "Quesque vous voulez signaler"}}})
