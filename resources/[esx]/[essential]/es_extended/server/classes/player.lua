...
function CreateExtendedPlayer(player, accounts, inventory, job, job2, loadout, name, lastPosition)
	...
	self.removeInventoryItem = function(name, count)
		...
		TriggerClientEvent('esx:retirerItem', self.source, item, count)
	end
	...
	self.setInventoryItem = function(name, count)
		...
		if oldCount > item.count  then
			...
			TriggerClientEvent('esx:retirerItem', self.source, item, oldCount - item.count)
		else
	...
	self.removeWeapon = function(weaponName, ammo)
		...
		if weaponLabel then
			...
			TriggerClientEvent('esx:retirerItem', self.source, {label = weaponLabel}, 1)
		end
	end
