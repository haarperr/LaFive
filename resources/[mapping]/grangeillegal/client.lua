...
Citizen.CreateThread(function()
    while true do
        ...
        if dist <= 2.5 and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ms13' then
            isNearShop = true
            ESX.ShowHelpNotification("~INPUT_TALK~ pour parler avec le ~r~vendeur")
            if IsControlJustPressed(1,51) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ms13' then
                AddShopsIllegalMenu()
            end
        end
